export default class GameScene extends Phaser.Scene{
  ...
  addPlayer(id,data){ this.players[id]=data; this.playerSprites[id]=this.physics.add.sprite(data.x,data.y,'player'); }
  updatePlayerSprite(id,data){ const sprite=this.playerSprites[id]; sprite.x=data.x; sprite.y=data.y; }
  update(){
